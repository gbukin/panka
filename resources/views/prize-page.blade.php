	...
	<section id="gift">
		<div class="gift-main">
			<div class="gift-main-left">
				...
				<img class="logo" src="{{asset('img/panka-lottery/pocket/Panka Logo fin.png')}}" alt="logo" data-aos="fade-right" data-aos-offset="200" data-aos-duration="1000">
				<img class="lucky-panka" src="{{asset('img/panka-lottery/pocket/LUCKYPANKA.png')}}" alt="panka" data-aos-delay="500" data-aos="fade-right" data-aos-duration="1000">
				<div class="gift-main-prize watchs" style="display: none;" data-aos-delay="500" data-aos="fade-right" data-aos-duration="1000">
					<img src="{{asset('img/panka-lottery/pocket/backgraundpinktablet.png')}}" class="prize-bg" alt="prize-bg">
			...
			<div class="gift-main-prize watchs">
				<img src="{{asset('img/panka-lottery/pocket/backgraundpinktablet.png')}}" class="prize-bg" alt="prize-bg" data-aos-delay="500" data-aos="fade-up" data-aos-duration="1000">
		...
		<div class="gift-list">
			<div class="gift-list-item">
				<div class="text">
					<div class="num"><img src="{{asset('img/panka-lottery/pocket/1 tablet.png')}}" alt="1"></div>
			...
			<div class="gift-list-item">
				<div class="text">
					<div class="num"><img src="{{asset('img/panka-lottery/pocket/2 tablet.png')}}" alt="2"></div>
			...
			<div class="gift-list-item">
				<div class="text">
					<div class="num"><img src="{{asset('img/panka-lottery/pocket/3 tablet.png')}}" alt="3"></div>
			...
			<div class="gift-contacts-left">
				...
				<div class="contacts">
					<a href="#" class="contacts-telegram">
						<img src="{{asset('img/panka-lottery/pocket/telegram.png')}}" alt="telegram">
					</a>
					<a href="tel:06-3989-0009" class="contacts-phone">06-3989-0009</a>
				</div>
				<img src="{{asset('img/panka-lottery/pocket/contacts-img.png')}}" alt="contacts-img">
			</div>
