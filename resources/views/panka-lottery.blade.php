...
<head>
    ...
    <link rel="stylesheet" href="{{asset('fonts/panka-lottery/stylesheet.css')}}">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('css/panka-lottery/reset.css')}}">
    <link rel="stylesheet" href="{{asset('css/panka-lottery/main.css')}}">
    <link rel="stylesheet" href="{{asset('css/panka-lottery/swiper-bundle.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/panka-lottery/jquery.fancybox.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/panka-lottery/media.css')}}">
</head>
<body>
...
<section id="top">
    <img src="{{asset('img/panka-lottery/light4.png')}}" alt="light" class="light-4">
    <img src="{{asset('img/panka-lottery/light3.png')}}" alt="light" class="light-3">
    <img src="{{asset('img/panka-lottery/light2.png')}}" alt="light" class="light-2">
    <img src="{{asset('img/panka-lottery/light1.png')}}" alt="light" class="light-1">
    <div class="top-lines">
        <img src="{{asset('img/panka-lottery/wave1.png')}}" alt="wave1">
    </div>
    <div class="top-video">
    ...
    <div class="top-block">
        ...
        <div class="top-block-imgs">
            <img src="{{asset('img/panka-lottery/main-img-item1.png')}}" style="display: none;" data-aos="fade-left" data-aos-offset="200"
                 data-aos-delay="4500" data-aos-duration="2000" alt="item1">
            <img src="{{asset('img/panka-lottery/main-img-item2.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1500"
                 data-aos-duration="4000" alt="item2">
            <img src="{{asset('img/panka-lottery/main-img-item3.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1500"
                 data-aos-duration="4000" alt="item3">
            <img src="{{asset('img/panka-lottery/main-img-item4.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1500"
                 data-aos-duration="4000" alt="item4">
            <img src="{{asset('img/panka-lottery/LUCKYPANKA-NEW.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-duration="1000"
                 alt="LUCKYPANKA">
        </div>
    </div>
</section>
...
<section id="prizes">
    ...
    <div class="prizes-items">
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/note2.png')}}" alt="prize">
            <p class="name">MacBook</p>
        </div>
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/prize3.png')}}" alt="prize">
            <p class="name">IPHONE 15</p>
        </div>
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/prize4.png')}}" alt="prize">
            <p class="name">iPad</p>
        </div>
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/prize2.png')}}" alt="prize">
            <p class="name">AirPods Max</p>
        </div>
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/prize1.png')}}" alt="prize">
            <p class="name">Apple Watch</p>
        </div>
        <div class="prizes-item" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500" data-aos-duration="1500">
            <img src="{{asset('img/panka-lottery/pocket/prize-pocket1.png')}}" alt="prize">
            <p class="name">PACK OF CROUTONS</p>
        </div>
    </div>
    <img src="{{asset('img/panka-lottery/Wave2.png')}}" class="line-2" alt="wave">
</section>
    ...
    <div class="etap">
        <div class="etap-item">
            <div class="etap-item-num">
                <img src="{{asset('img/panka-lottery/etap-line.png')}}" alt="etap-line" data-aos="fade-right" data-aos-offset="200"
                     data-aos-duration="1500">
                <img src="{{asset('img/panka-lottery/1.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1000"
        ...
        <div class="etap-item">
            ...
            <div class="etap-item-num">
                <img src="{{asset('img/panka-lottery/2.png')}}" alt="2" data-aos="fade-left" data-aos-offset="200" data-aos-delay="1000"
                     data-aos-duration="1500">
                <img src="{{asset('img/panka-lottery/etap-line.png')}}" alt="etap-line" data-aos="fade-left" data-aos-offset="200"
                     data-aos-duration="1500">
            </div>
        </div>
        <div class="etap-item">
            <div class="etap-item-num">
                <img src="{{asset('img/panka-lottery/etap-line.png')}}" alt="etap-line" data-aos="fade-right" data-aos-offset="200"
                     data-aos-duration="1500">
                <img src="{{asset('img/panka-lottery/3.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1000"
        ...
        <div class="etap-item">
            ...
            <div class="etap-item-num">
                <img src="{{asset('img/panka-lottery/4.png')}}" alt="4" data-aos="fade-left" data-aos-offset="200" data-aos-delay="1000"
                     data-aos-duration="1500">
                <img src="{{asset('img/panka-lottery/etap-line.png')}}" alt="etap-line" data-aos="fade-left" data-aos-offset="200"
                     data-aos-duration="1500">
            </div>
        ...
        <div class="etap-item">
            <div class="etap-item-num">
                <img src="{{asset('img/panka-lottery/etap-line.png')}}" alt="etap-line" data-aos="fade-right" data-aos-offset="200"
                     data-aos-duration="1500">
                <img src="{{asset('img/panka-lottery/5.png')}}" data-aos="fade-right" data-aos-offset="200" data-aos-delay="1000"
    ...
    <div class="bottom-footer" id="contacts" data-aos="fade-bottom" data-aos-offset="200" data-aos-duration="2000">
        <div class="bottom-footer-contacts">
            <a href="tel:+660951860009" class="phone">
                <img src="{{asset('img/panka-lottery/phone.png')}}" alt="phone">
                +660951860009
            </a>
            <a href="mailto:pankacroutons@gmail.com" class="email">
                <img src="{{asset('img/panka-lottery/email.png')}}" alt="email">
...
<script src="{{asset('js/panka-lottery/all.js')}}"></script>
<script src="{{asset('js/panka-lottery/swiper-bundle.min.js')}}"></script>
<script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
<script>
    AOS.init();
</script>
<script src="{{asset('js/panka-lottery/main.js')}}"></script>
</body>
</html>
